...
using Sedion.SimpleTask.Web.Controllers.Results;
using Sedion.SimpleTask.Web.Models.Account;
using Sedion.SimpleTask.Web.MultiTenancy;

namespace Sedion.SimpleTask.Web.Controllers
{
    //[AbpMvcAuthorize]
    public class AccountController : SimpleTaskControllerBase
    {
        ...
        public ActionResult Login(string userNameOrEmailAddress = "", string returnUrl = "", string successMessage = "")
        {
            ...
            /* returnUrl & isMultiTenancyEnabled */
