...
namespace Sedion.SimpleTask.Tests
{
    public abstract class SimpleTaskTestBase : AbpIntegratedTestBase
    {
        protected SimpleTaskTestBase()
        {
            //Seed initial data
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<SimpleTaskApplicationModule>();
            modules.Add<SimpleTaskDataModule>();
        }

        public void UsingDbContext(Action<SimpleTaskDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<SimpleTaskDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<SimpleTaskDbContext, T> func)
        {
            T result;
